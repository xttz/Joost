...
class contact_item_link_menu {
	...
	function edit(&$uid,$menutype,$option,$menu) {
		...
		if($uid) {
			...
			$lists['contact'] = mosHTML::selectList($contacts,'contact_item_link','ondblclick="jadd(\'name\',this.options[this.selectedIndex].text);" class="inputbox" size="10"','value','text','');
		}
