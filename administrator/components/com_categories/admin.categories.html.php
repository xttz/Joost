	...
	<script language="javascript" type="text/javascript">
		function submitbutton(pressbutton) {
			...
			if (!getSelectedValue( 'adminForm', 'sectionmove' )) {
				alert( "<?php echo _CHOOSE_CATEGORY_SECTION?>" );
			} else {
				submitform( pressbutton );
			}
		}
	...
	<table class="adminform">
		<tr>
			...
			<td align="left" valign="top" width="30%">
				<strong><?php echo _MOVE_INTO_SECTION?>:</strong>
				<br />
						<?php echo $SectionList ?>
				<br /><br />
			</td>
			<td align="left" valign="top" width="20%">
				<strong><?php echo _CATEGORIES_TO_MOVE?>:</strong>
				<br />
						<?php
						echo "<ol>";
			...
			<td valign="top" width="20%">
				<strong><?php echo _CONTENT_ITEMS_TO_MOVE?>:</strong>
				<br />
						<?php
						echo "<ol>";
			...
			<td valign="top">
						<?php echo _IN_SELECTED_SECTION_WILL_BE_MOVED_ALL?>
			</td>.
		</tr>
	</table>
	<br /><br />
