...
DEFINE('_MODULE_IS_EDITING_MY_ADMIN','Модуль в даний момент редагується іншим адміністратором//The module is currently being edited by another administrator');
...
DEFINE('_MENU_ITEM_COMPONENT_LINK','Пункт меню :: Посилання - Об’єкт компонента');
...
DEFINE('_CATEGORY_TITLE_IF_FILED_IS_EMPTY','Якщо поле буде незаповнене, то автоматично буде використано назву категорії');
...
DEFINE('_SECTION_TITLE_IF_FILED_IS_EMPTY','Якщо поле буде незаповнене, то автоматично буде використано назву розділу');
...
DEFINE('_LINKED_TO_NEWSFEED','Пов’язано зі стрічкою');
DEFINE('_MENU_ITEM_SEPARATOR','Пункт меню :: Розділювач / Заповнювач');
DEFINE('_ENTER_URL_PLEASE','Ви повинні ввести url.');
DEFINE('_MENU_ITEM_URL','Пункт меню :: Посилання - URL');
DEFINE('_MENU_ITEM_LINKS_CATEGORY','Пункт меню :: Таблиця - Web-посилання категорії');
...
DEFINE('_NOTE_MENU_ITEMS1','* Зверніть увагу, що деякі пункти меню входять в кілька груп, але вони відносяться до одного типу меню.');
...
DEFINE('_NEW_MENU_ITEM','Новий пункт меню');
DEFINE('_ALL_CATEGORIES','- всі категорії -');
DEFINE('_MENU_MANAGER','Керування меню');
DEFINE('_COM_MENUS_ORDER_DROPDOWN','Порядок');
DEFINE('_COM_MENUS_SUBMIT_CONTENT','Пункт меню :: Додати вміст');
DEFINE('_MOVE_MENUS','переміщено');
DEFINE('_MOVE_MENUS_TO','переміщено в');
