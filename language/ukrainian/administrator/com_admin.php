...
DEFINE('_PHP_SETTINGS', 'Важливі налаштування PHP');
...
DEFINE('_CHECK_VERSION', 'Перевірити останню версію Joostina');
DEFINE('_CACHE_CLEAR_ALL', 'Весь кеш очищено');
DEFINE('_CACHE_CLEAR_CONTENT', 'Кеш вмісту очищений');