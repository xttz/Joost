...
DEFINE('_UNSUCCESS_OPERATION_NO_TEMPLATE','Операція невдала: Не визначено шаблон.');
...
DEFINE('_NO_PREVIEW','Попередній перегляд недоступний');
DEFINE('_TEMPLATE_PREVIEW','Попередній перегляд шаблону');
...
DEFINE('_TEMPLATE_USE_IN_CONFIG','(Вибрано в глобальній конфігурації)');
DEFINE('_TEMPLATE_EDITOR_HEADER','HTML-редактор шаблону');