...
DEFINE('_NEWSFEEDS_NUM_OF_CONTENT_ITEMS','Кількість статей');
DEFINE('_NEWSFEED_CACHE_TIME','Час кешу (секунд)');
...
DEFINE('_PLEASE_ENTER_NEWSFEED_CACHE_TIME','Будь ласка, введіть час оновлення кешу');
