...
DEFINE('_SECTION_COPY_DESCRIPTION','У новостворений розділ будуть <br />скопійовані перелічені категорії <br />і всі перелічені об’єкти <br />вмісту категорій.');
...
DEFINE('_ERROR_WHEN_ADDING','сталася помилка при додаванні');
DEFINE('_SECTION_IS_BEING_EDITED_BY_ADMIN','Розділ в даний момент редагується іншим адміністратором');
...
DEFINE('_SECTION_CONTENT_COPYED','Вибраний вміст розділу було скопійовано в розділ');
DEFINE('_MENU_MASS_ADD','Додати ще');
DEFINE('_CONTENT_STATIC','- Статичний вміст -');
DEFINE('_CREATE_CATEGORY','Створити категорію');
DEFINE('_SECTION_TYPE','Тип розділу');
DEFINE('_SECTION_CAT_CONTENT_LIST','Записи по групах категорій');
DEFINE('_SECTION_CATEGORIES_LIST','Список категорій');