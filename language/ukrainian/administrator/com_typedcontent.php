...
DEFINE('_DATE_PUBL_END','Збіг термін публікації');
DEFINE('_EDIT_CONTENT_TYPED','Змінити статичний вміст');
DEFINE('_WANT_TO_RESET_HITCOUNT','Ви дійсно хочете обнулити лічильник переглядів? \nНезбережені зміни цього вмісту будуть втрачені.');
...
DEFINE('_MENU_LINK_3','Тут створюється пункт меню типу \'Посилання - Статичний вміст\', який вставляється в обране зі списку меню');
DEFINE('_EXISTED_MENU_LINKS','Існуючі зв’язки з меню');
DEFINE('_CONTENT_SAVED','Вміст збережено');
...
DEFINE('_ORDER_BY_ASC','Порядок за зростанням');
DEFINE('_ORDER_BY_DESC','Порядок за спаданням');
DEFINE('_ORDER_BY_ID_ASC','За зростанням ID');
DEFINE('_ORDER_BY_ID_DESC','За спаданням ID');
DEFINE('_ORDER_BY_TITLE_ASC','Заголовки за алфавітом');
DEFINE('_ORDER_BY_TITLE_DESC','Заголовки проти алфавіту');
DEFINE('_ORDER_BY_DATE_ASC','Дата за зростанням');
DEFINE('_ORDER_BY_DATE_DESC','Дата за спаданням');
DEFINE('_ORDER_BY_AUTORS_ASC','Автори за алфавітом');
DEFINE('_ORDER_BY_AUTORS_DESC','Автори проти алфавіту');
DEFINE('_ORDER_BY_PUBL_ASC','Спочатку неопубліковані');
DEFINE('_ORDER_BY_PUBL_DESC','Спочатку опубліковані');
DEFINE('_ORDER_BY_ACCESS_ASC','Доступ за зростанням');
DEFINE('_ORDER_BY_ACCESS_DESC','Доступ за спаданням');
...
DEFINE('_EMPTY_CATEGORY','Дана категорія не містить об’єктів.');
...
DEFINE('_LAST_CHANGE','Останнє редагування');
...
DEFINE('_OBJ_ARCHIVED','Об’єкт(и) успішно архівований(і)');
...
DEFINE('_OBJECTS_COPIED_TO_SECTION','Об’єкт(и) успішно скопійований(і) в розділ');
...
DEFINE('_USED_IMAGES','Зображення, що використовуються');
