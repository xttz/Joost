...
DEFINE('_JWMM_DIRECTORY_NOT_EMPTY','Каталог не порожній. Будь ласка, видаліть спочатку вміст каталогу!');
...
DEFINE('_JWMM_CATALOG_CREATED','Створено каталог');
DEFINE('_JWMM_CATALOG_NOT_CREATED','Каталог не створено');
...
DEFINE('_FILES_UNPACKED','Файл(ів) розпаковано');
DEFINE('_ERROR_WHEN_UNPACKING','Помилка розпаковування');
DEFINE('_FILE_IS_NOT_A_ZIP','Файл не є коректним архівом ZIP');
DEFINE('_FILE_NOT_EXISTS','Файл не існує');
DEFINE('_IMAGE_SAVED_AS','Відредаговане зображення збережено як');
DEFINE('_IMAGE_NOT_SAVED','Зображення НЕ збережено');
DEFINE('_FILES_NOT_UPLOADED','Файл(и) НЕ завантажені на сервер');
DEFINE('_FILES_UPLOADED','Фото долучено');
DEFINE('_DIRECTORIES','Каталоги');
DEFINE('_JWMM_FILE_NAME_WARNING','Будь ласка, не використовуйте в назвах пробіли і спецсимволи');
DEFINE('_MEDIA_MANAGER','Медіа менеджер');
DEFINE('_JWMM_CREATE_DIRECTORY','Створити каталог');
DEFINE('_UPLOAD_FILE','Завантажити файл');
DEFINE('_FILE_PATH','Розташування');
...
DEFINE('_JWMM_BORDER','Рамка');
DEFINE('_COLOR','Колір');
DEFINE('_JWMM_ALL_BORDERS','Всі рамки');
...
DEFINE('_JWMM_IMAGE_LINK','Шлях файлу до:');
DEFINE('_JWMM_IMAGE_HREF','Тег-посилання на файл:');
DEFINE('_JWMM_IMAGE_TAG','Тег зображення вставки:');
DEFINE('_JWMM_CLICK_TO_URL','Натисніть для отримання посилань');
DEFINE('_JWMM_FILE','Файли');