...
DEFINE('_NO_QUOTES_IN_NAME','Название меню не должно содержать \\\'');
...
DEFINE('_NEW_MENU_ITEM_TIP','* Новый модуль меню будет автоматически создан после того, как вы введете заголовок, а затем нажмете кнопку "Сохранить".*<br /><br />Редактирование параметров созданного модуля будет доступно в разделе \'Управления модулями [сайт]\': Модули -> Модули сайта');
