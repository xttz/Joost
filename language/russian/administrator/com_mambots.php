...
DEFINE('_COM_MAMBOTS_NON_EDIT','редактирвуется другим администратором');
DEFINE('_COM_MAMBOTS_NON_REORDER','Порядок расположения этого мамбота не может быть изменен');